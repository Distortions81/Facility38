...
GOGC=100 GOOS=linux GOARCH=amd64 go build -ldflags="-s -w -X main.buildTime=$curTime -X main.UPSBench=true -X main.LoadTest=true" -o BUILD/builds/GameTest-$curTime-linux64-bench
