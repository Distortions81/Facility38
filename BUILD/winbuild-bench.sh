...
GOGC=100 GOOS=windows GOARCH=amd64 go build -ldflags="-s -w -X main.buildTime=$curTime -X main.NoDebug -X main.UPSBench=true -X main.LoadTest=true" -o BUILD/builds/GameTest-win64-raw.exe
