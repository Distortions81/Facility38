...
GOGC=100 GOOS=linux GOARCH=amd64 go build -trimpath -ldflags="-s -w -X main.buildTime=$versionString -X main.NoDebug=true" -o BUILD/builds/Facility38-$versionString-linux64
