...
GOOS=windows GOARCH=amd64 go build -pgo=auto -trimpath -gcflags=all="-B" -ldflags="-s -w -X main.buildTime=$curTime" -o $path/Facility-38/Facility-38-win64-raw.exe
...
scp -P 5313 Facility-38-$versionString-win64.zip dist@facility38.go-game.net:~/F38Auth/www/dl/
