...
var MatTypes = []*world.MaterialType{
	...
	{Symbol: "FeR", Name: "Iron Rod", Base: "iron-rod",
		...
		UnitName: "kg", TypeI: def.MAT_IRON_ROD},

	{Symbol: "CuR", Name: "Copper Rod", Base: "copper-rod",
		Density: 8.88, KG: 10,
		IsDiscrete: true, IsSolid: true, IsRod: true,
		UnitName: "kg", TypeI: def.MAT_COPPER_ROD},

	{Symbol: "SgR", Name: "Slag Rod", Base: "slag-rod",
		Density: 2.5, KG: 10,
		IsDiscrete: true, IsSolid: true, IsRod: true,
		UnitName: "kg", TypeI: def.MAT_SLAG_ROD},

	/* Sheet Metal */
	{Symbol: "FeS", Name: "Iron Sheet", Base: "iron-sheet",
		Density: 7.13, KG: 10,
		IsDiscrete: true, IsSolid: true, IsSheetMetal: true,
		UnitName: "kg", TypeI: def.MAT_IRON_SHEET},

	{Symbol: "CuS", Name: "Copper Sheet", Base: "copper-sheet",
		Density: 8.88, KG: 10,
		IsDiscrete: true, IsSolid: true, IsSheetMetal: true,
		UnitName: "kg", TypeI: def.MAT_COPPER_SHEET},

	{Symbol: "SgS", Name: "Slag Sheet", Base: "slag-sheet",
		Density: 2.5, KG: 10,
		IsDiscrete: true, IsSolid: true, IsSheetMetal: true,
		UnitName: "kg", TypeI: def.MAT_SLAG_SHEET},

	/* Object */
	{Symbol: "OBJ", Name: "Object", Base: "obj", UnitName: "count", TypeI: def.MAT_OBJ},
}
